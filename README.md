...
| :----------------------------------------------------------------: | :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="frontend/src/public/assets/Jessica.png" width="80"> | Ang Hui Peng Jessica | Designed the Home page, reporter dashboard                                                                                                                                                                                                                                                                                                        |
...
|   <img src="frontend/src/public/assets/Ryan.png" width="80">   | Chua Wee Chye Ryan   | Designed Status page, Admin page, nav bar, integrated backend logic, setup Docker and AI camera API on google cloud platform                                                                                                                                                                                                                                                                 |
| <img src="frontend/src/public/assets/Ruixuan.png" width="80"> | Low Rui Xuan         | Designed Guidebook, Login & Signup page, ensure overall frontend consistency                                                                                                                                                                                                                                                                                       |
...
|Generating Website concepts, layouts, or themes|Yes|Search for possible themes and colour palettes that we could have for our website|
...
|Explaining coding errors / debugging hints|Yes|Used when certain bugs were hard to spot manually, especially in longer sections of code, to understand what might be going wrong.|
|Boilerplate code generation (starter code, small code snippets)|Yes|Used to generate basic starting structure when implementing things learnt outside of class, which we modified to fit project. Used to generate small code snippets to help with minor issues faced, for example aligning items|
...
|Core Implementation tasks|Yes|We used AI/LLMs to generate code for us for specific pages and used the code. However, we tested and understood the code, ensured the logic was working as expected, making changes as necessary, and integration with Vue and the rest of the project was done by us.|
|Major business logic, backend endpoints, or critical frontend interactivity|No| Any code generated by AI was tested, checked and integrated by us. It did not implement the business logic, endpoints or interactivity, and the final implementation was still done by us.|
Solving significant implementation issues|No|We did use AI/LLMs to point out possible reasons or suggest other methods to diagnose the issue when faced with major issues. AI/LLMs generated code for us, but we had to test and integrate it, or further prompt it based on our problem solving process. So it played a part in solving implementation issues, but discovering the problem and the main problem solving process was conducted by us.|
